...
class StudentsDataThirdSecondaryScreen extends StatefulWidget {
  const StudentsDataThirdSecondaryScreen({super.key});

  @override
  State<StudentsDataThirdSecondaryScreen> createState() =>
      _StudentsDataThirdSecondaryScreenState();
}

class _StudentsDataThirdSecondaryScreenState
    extends State<StudentsDataThirdSecondaryScreen> {
                  ...
                  children: [
                    Padding(
                      ...
                      child: CousstomStudentAppBar(
                        tittel: " بيانات الطلاب في الصف الثالث الثانوي👥",
                      ),
                    ),
